...
check_design >> reports/dft_check_design.rpt
...
report_timing -delay_type min -max_paths 20 > reports/dft_hold.rpt
report_timing -delay_type max -max_paths 20 > reports/dft_setup.rpt
report_clock -attributes > reports/dft_clocks.rpt
report_constraint -all_violators -nosplit > reports/dft_constraints.rpt
