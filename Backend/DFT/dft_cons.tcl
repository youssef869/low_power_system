...
set_input_delay $in3_delay -clock $SCAN_CLK_NAME [get_port SCAN_IN]
set_input_delay $in3_delay -clock $SCAN_CLK_NAME [get_port SCAN_EN]

#Constrain Scan Output Paths
set_output_delay $out3_delay -clock $SCAN_CLK_NAME [get_port SCAN_OUT]
...
set_driving_cell -library scmetro_tsmc_cl013g_rvt_ss_1p08v_125c -lib_cell BUFX2M -pin Y [get_port SCAN_IN]
set_driving_cell -library scmetro_tsmc_cl013g_rvt_ss_1p08v_125c -lib_cell BUFX2M -pin Y [get_port SCAN_EN]
...
#scan ports
set_load 0.5 [get_port SCAN_OUT]
